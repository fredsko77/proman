 ...
 */
final class Version20221220074806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD type_id INT DEFAULT NULL, DROP type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD type VARCHAR(50) DEFAULT NULL, DROP type_id');
    }
}
